// Generated by scripts/build-reviewed-challenges.mjs. Do not edit by hand.
// Only reviewed, fictionalized, public-release-approved content is compiled here.

export const challenge01ContentVersion = "1.0.0";
export const challenge01ContentDigest = "sha256:e4126dbea5eb91b68e9cf305c444a1693a1e582dd7ec35c4dafe2f26ab826541";
export const challenge01CompatibilityHash = "sha256:challenge01-v1.0.0";
export const challenge01GeneratedRecord = {
  "playerFacing": {
    "schemaVersion": "1.0.0",
    ...
    "metadata": {
      ...
      "priorArtStipulation": "For this exercise only, every reference included in the selected mode is stipulated to be available prior art. The player is not asked to analyze statutory prior-art dates.",
      "revisionNotes": [
    ...
    "modes": {
      "guided": {
        "id": "guided",
        "label": "Guided",
        "description": "Formatting help, disclosure prompts, visible core references, target embodiments, and one substantive hint.",
        "claimBudget": {
          "independent": 1,
          "dependent": 5,
          "total": 6
      ...
      "practitioner": {
        "id": "practitioner",
        "label": "Practitioner",
        "description": "Mechanical drafting help, visible core references, a six-claim budget, and one amendment or argument round.",
        "claimBudget": {
          "independent": 1,
          "dependent": 5,
          "total": 6
      ...
      "examiner": {
        "id": "examiner",
        "label": "Examiner",
        "description": "Prior art and target embodiments are concealed during drafting, the expert record applies, and no substantive hints are available.",
        "claimBudget": {
          "independent": 1,
          "dependent": 3,
          "total": 4
    ...
    "educationalBoundary": {
      "short": "ScopeCraft is a drafting and issue-spotting simulator. Results are limited to this fixed challenge record.",
      "full": "This exercise is educational. It is not legal advice and does not provide a patentability, validity, infringement, or freedom-to-operate opinion. A simulated result reports only what happened under the stipulated facts, references, mappings, and evaluator rules in this challenge.",
      "officeAction": "This is a simulated Office Action based only on the frozen challenge record. It is not a USPTO action or a conclusion about actual patentability.",
      "competitor": "A missing literal mapping in this fictional product model is not a noninfringement opinion. Real analysis requires claim construction, current legal status, prosecution history, related rights, jurisdiction, and facts concerning the actual product.",
      "final": "The result is limited to the ScopeCraft challenge record and must not be used as a real patentability or noninfringement conclusion."
    },
    "disclosure": {
      "title": "Pressure-History Adaptive Mouse",
      ...
      "sections": [
        {
          ...
          "body": "A fixed pressure-to-scroll relationship can feel too aggressive for one user and too slow for another. It may also become less suitable as a user's grip or fatigue changes. Existing manual sensitivity settings require deliberate calibration and may not identify the pressure ranges associated with overshooting a target location.",
          "anchorIds": [
            "support-problem-fixed-response",
            "support-problem-changing-use"
          ]
        },
        {
          "id": "disclosed-improvement",
          "title": "Disclosed improvement",
          "body": "The system learns a user-specific pressure-to-scroll transfer function from ordinary scrolling. It associates pressure values with later correction labels, derives correction measures for pressure intervals, selectively updates an implicated interval, and uses the resulting mapping during later operation.",
          "anchorIds": [
        ...
        },
        {
          ...
          "body": "The packet expressly supports the structures, sensors, processing locations, timing ranges, sample rules, function forms, profiles, outlier handling, and continuous outputs listed below.",
          "anchorIds": [
        ...
        },
        {
          ...
          "body": "Cover mice having different pressure-sensor technologies and different placements of the learning controller. Avoid limiting the independent claim to a rotatable wheel, a force-sensing resistor, processing inside the mouse, or a particular application.",
          "anchorIds": [
            "support-commercial-breadth"
          ]
        },
        {
          "id": "claim-task",
          "title": "Claim task",
          "body": "Draft the broadest supported independent system or apparatus claim you believe can survive the supplied record, then create a meaningful fallback ladder. Refine nouns and relationships already introduced in the parent claim before adding incidental hardware.",
          "anchorIds": []
        }
      ],
      "anchors": [
        {
          ...
          "text": "A fixed pressure-to-scroll relationship can feel too aggressive for one user and too slow for another.",
          "conceptIds": [
        ...
        },
        {
          ...
          "text": "A pressure-to-scroll relationship may become less suitable as a user's grip or fatigue changes, and manual settings may not identify pressure ranges associated with overshooting.",
          "conceptIds": [
            "pressure-interval",
            "correction-sequence"
          ]
        },
        {
          ...
          "text": "Each selected scrolling interaction may be stored as a record containing a pressure value, the direction and amount of a scrolling command, and a correction label indicating whether an opposite-direction input occurred within a correction interval.",
          "conceptIds": [
            "interaction-record",
            "pressure-value",
            "scrolling-command",
        ...
        },
        {
          ...
          "text": "Records are grouped into pressure intervals, and a correction measure is derived for each interval from the records assigned to that interval.",
          "conceptIds": [
            "interaction-record",
            "pressure-interval",
            "correction-measure",
        ...
        },
        {
          ...
          "text": "When a correction measure satisfies an update threshold, the system changes the scroll gain for the implicated pressure interval while retaining the gain assigned to one or more other pressure intervals.",
          "conceptIds": [
            "correction-measure",
            "update-threshold",
            "mapping-value",
        ...
        },
        {
          ...
          "text": "During later operation, the system locates the pressure interval containing a current pressure value, applies the gain associated with that interval, and produces a scrolling command.",
          "conceptIds": [
            "pressure-value",
            "pressure-interval",
            "mapping-value",
        ...
        },
        {
          ...
          "text": "The pressure-responsive element may be a depressible button, pressure-sensitive strip, squeeze region, or pressure-responsive scroll wheel.",
          "conceptIds": [
        ...
        },
        {
          ...
          "text": "Pressure may be detected with a force-sensing resistor, capacitive sensor, piezoelectric sensor, strain gauge, or another sensor producing a value representative of applied force.",
          "conceptIds": [
            "pressure-sensor",
            "pressure-value"
          ]
        },
        {
          ...
          "text": "Processing may occur in the pointing device, the host, or a controller distributed between them.",
          "conceptIds": [
            "processor",
        ...
        },
        {
          ...
          "text": "The learning technique may control cursor displacement, zooming, timeline navigation, or another continuous navigation output, although scrolling is the primary embodiment.",
          "conceptIds": [
        ...
        },
        {
          ...
          "text": "The desired claim should cover different pressure sensors and controller placements without requiring a rotatable wheel, force-sensing resistor, processing inside the mouse, or a particular application.",
          "conceptIds": [
            "pressure-responsive-element",
            "pressure-sensor",
            "processor",
      ...
      "supportedAlternatives": [
        ...
        },
        {
          ...
          "values": [
            "pointing device",
            "host",
            "distributed between pointing device and host"
          ],
        ...
        },
        {
          ...
          "category": "history",
          "values": [
            "rolling window of the most recent 20 to 500 records"
          ],
        ...
        },
        {
          ...
          "values": [
            "at least 5 records in a pressure interval"
          ],
        ...
        },
        {
          ...
          "values": [
            "piecewise linear",
            "constrained to remain monotonic"
          ],
    ...
    "priorArt": {
      "instructions": "The reference cards summarize selected teachings and link to full publications. Players may inspect each full publication, but the simulator evaluates only the curated, versioned challenge evidence facts and identifies the configured fact used for each finding.",
      "statusNotice": "Publication use in this exercise does not state current enforceability or legal status. Prior-art availability is stipulated only for game play.",
      "sourceFreezePolicy": {
        "version": "1.0.0",
        "scope": "Each card freezes a curated pinpoint manifest and ScopeCraft teaching summary, not the full patent document.",
        "requiredFields": [
          "publication number",
          "source URL",
          "retrieval date",
        ...
        "fullDocumentPolicy": "Link to the public source. Do not download or embed a full patent PDF in the Challenge 01 data bundle.",
        "stabilityPolicy": "Deterministic findings use the versioned evidence facts and pinpoints in the bundle. Any later evidence revision must increment the content version and regenerate affected manifest hashes."
      },
      "cards": [
        {
          "id": "ref-a",
          ...
          "summary": "A mouse can use a pressure-sensitive scrolling control, and current pressure can control continuous scrolling speed.",
          "strengths": [
          ...
          "pinpoints": [
            ...
            },
            {
              ...
              "excerptType": "ScopeCraft paraphrase",
              "excerpt": "A short activation is distinguished from continuous pressure-dependent movement, with scrolling expressly recited.",
              "conceptIds": [
                "pressure-value",
                "scrolling-command",
                "scrolling-amount"
            ...
            },
            {
              ...
              "excerptType": "ScopeCraft paraphrase",
              "excerpt": "Pressure-sensitive mouse structures provide pressure-responsive scrolling control.",
              "conceptIds": [
                "pressure-responsive-element",
                "pressure-sensor"
              ]
          ...
          "frozenEvidenceManifest": {
            "snapshotId": "ref-a-curated-evidence-v1",
            "retrievalDate": "2026-08-24",
            "snapshotScope": "ScopeCraft-curated pinpoint manifest and paraphrased teaching summaries; no full patent text or PDF is embedded.",
            "hashAlgorithm": "SHA-256",
            "hashInput": "US20030107547A1|2026-08-24|claims 2,5,11,16,17|paragraphs 13,29,34",
            "contentHash": "a2ed0b351e9cf52224987574f2c36c2757cbad15a4a13ed76520ba0cf678214b"
          },
          "statusNotice": "Used for its disclosure in this exercise. This card does not state current enforceability, ownership, term, or legal status."
        },
        {
          "id": "ref-b",
          "label": "Reference B",
          ...
          "summary": "A scrolling agent may tune or select a scrolling algorithm from learned behavior, including a rapid scroll followed by a short opposite-direction correction.",
          "strengths": [
          ...
          "pinpoints": [
            {
              ...
              "excerptType": "ScopeCraft paraphrase",
              "excerpt": "Input factors and learned behavior are used to select or tune scrolling speed and sensitivity.",
              "conceptIds": [
                "scrolling-command",
                "scrolling-amount",
                "historical-adaptation"
            ...
            },
            {
              ...
              "excerptType": "ScopeCraft paraphrase",
              "excerpt": "A short reverse correction following rapid scrolling can indicate that acceleration was excessive.",
              "conceptIds": [
                "correction-sequence",
                "correction-interval"
              ]
          ...
          "frozenEvidenceManifest": {
            "snapshotId": "ref-b-curated-evidence-v1",
            "retrievalDate": "2026-08-24",
            "snapshotScope": "ScopeCraft-curated pinpoint manifest and paraphrased teaching summaries; no full patent text or PDF is embedded.",
            "hashAlgorithm": "SHA-256",
        ...
        },
        {
          ...
          "summary": "Mouse input can be monitored and modified from patterns indicating user difficulty, with compensation parameters stored by user or application.",
          "strengths": [
          ...
          "pinpoints": [
            {
              ...
              "excerptType": "ScopeCraft paraphrase",
              "excerpt": "Pointing-device resolution may be altered from input patterns using user-specific or application-specific parameters.",
              "conceptIds": [
                "historical-adaptation",
                "profile-specific-mapping"
              ]
            },
            {
              ...
              "excerptType": "ScopeCraft paraphrase",
              "excerpt": "Patterns suggesting user difficulty can trigger automatic mouse compensation.",
              "conceptIds": [
                "historical-adaptation"
              ]
            },
          ...
          "frozenEvidenceManifest": {
            "snapshotId": "ref-c-curated-evidence-v1",
            "retrievalDate": "2026-08-24",
            "snapshotScope": "ScopeCraft-curated pinpoint manifest and paraphrased teaching summaries; no full patent text or PDF is embedded.",
            "hashAlgorithm": "SHA-256",
        ...
        },
        {
          ...
          "summary": "Mouse states and sensitivity may correspond to pressure ranges, user or application context, calibration samples, and editable response-curve parameters.",
          "strengths": [
          ...
          "pinpoints": [
            ...
            },
            {
              ...
              "locator": "claim 11",
              "excerptType": "ScopeCraft paraphrase",
              "excerpt": "State-change criteria may depend on applications, device attributes, user settings, or usage habits.",
              "conceptIds": [
                "profile-specific-mapping",
                "historical-adaptation"
              ]
            },
            {
              ...
              "excerptType": "ScopeCraft paraphrase",
              "excerpt": "Guided calibration uses measured pressure samples to establish sensitivity settings.",
              "conceptIds": [
                "pressure-value",
                "pressure-interval",
                "pressure-to-scroll-mapping"
          ...
          "frozenEvidenceManifest": {
            "snapshotId": "ref-d-curated-evidence-v1",
            "retrievalDate": "2026-08-24",
            "snapshotScope": "ScopeCraft-curated pinpoint manifest and paraphrased teaching summaries; no full patent text or PDF is embedded.",
            "hashAlgorithm": "SHA-256",
            "hashInput": "US20230168751A1|2026-08-24|claims 9,11|paragraphs 36,84-91,117-128,139-141",
      ...
      "concepts": [
        {
          ...
          "synonyms": [
            "input system",
            "pointing-device system",
            "mouse system"
          ],
          "caution": "A mouse is a disclosed commercial embodiment, but the supported system wording need not require mouse-specific housing structure."
        },
        {
        ...
        },
        {
          ...
          "synonyms": [
            "force value",
            "value representative of applied force",
            "pressure sample"
          ]
        },
        {
        ...
        },
        {
          ...
          "caution": "Controller wording must remain broad enough to cover processing in the device, host, or distributed between them when that breadth is intended."
        },
        {
        ...
        },
        {
          ...
          "kind": "data-structure",
          "synonyms": [
            "pressure-to-scroll transfer function",
            "pressure-response curve",
            "scroll-gain mapping"
          ],
          "caution": "A generic mapping does not necessarily require separate pressure intervals or localized updates."
        },
        {
          "id": "mapping-value",
          "label": "mapping value",
        ...
        },
        {
          ...
          "caution": "Speed, distance, and magnitude can describe different implementations; treat them as related only where the claim language and packet support permit."
        },
        {
          ...
          "kind": "event-relation",
          "synonyms": [
            "reverse-scroll correction",
            "opposite-direction correction sequence"
          ]
        },
        {
        ...
        },
        {
          ...
          "synonyms": [
            "localized mapping update",
            "range-specific adjustment"
          ]
        },
        {
        ...
        },
        {
          ...
          "synonyms": [
            "continuous navigation command",
            "continuous interface movement"
          ]
        }
      ],
      "relations": [
    ...
    "editorScaffold": {
      "independent": "1. A [supported system or apparatus] comprising:\n    [introduce a supported component];\n    [introduce another supported component]; and\n    [recite supported operations and relationships].",
      "dependent": "The [system] of claim [number], wherein [further limit an introduced noun or relationship].",
      "ghostTextPolicy": "Ghost text teaches claim grammar and structure. It must not supply a hidden inventive answer.",
    ...
    "glossary": [
      {
        ...
        "definition": "A drafting relationship that makes clear which previously introduced claim element a later reference identifies.",
        "help": "Introduce an element before referring to it as 'the' or 'said' element."
      },
      {
        "id": "glossary-dependent-claim",
        "term": "dependent claim",
        "definition": "A claim that refers to an earlier claim and adds a further limitation to the inherited combination.",
        "help": "Start from a noun or relationship already introduced in the parent, then add a supported fallback with commercial or prosecution value."
      },
      {
        "id": "glossary-anticipation",
        "term": "anticipation",
        "definition": "For this simulator, a single reference must map every limitation of the claim under the fixed evidence rules.",
        "help": "A multiple-reference mapping belongs in the obviousness analysis, not the anticipation label."
      },
      {
        "id": "glossary-obviousness",
        "term": "obviousness",
        "definition": "A simulated whole-claim assessment that may combine references only with an articulated reason grounded in the challenge record.",
      ...
      },
      {
        ...
        "definition": "Subject matter conveyed by the original fictional disclosure rather than invented during amendment.",
        "help": "Every added limitation should trace to one or more support anchors."
      },
      {
        "id": "glossary-literal-mapping",
        "term": "literal mapping",
        "definition": "A limitation-by-limitation comparison to the stipulated fictional product facts in this exercise.",
        "help": "No complete mapping located is deliberately narrower than saying a product does not infringe."
      },
      {
        "id": "glossary-frozen-record",
        "term": "frozen record",
        "definition": "The stipulated references, evidence facts, and evaluator rules used to keep a challenge replay reasonably stable.",
  ...
  "evaluator": {
    ...
    "fixtures": {
      "initialClaims": [
        {
          ...
          "limitations": [
            ...
            },
            {
              ...
              "text": "a pressure-responsive scrolling element configured to generate pressure values in response to user inputs",
              "conceptIds": [
                "pressure-responsive-element",
                "pressure-value"
              ],
            ...
            },
            {
              ...
              "text": "determine, using the pressure-to-scroll mapping, respective scrolling amounts for the pressure values",
              "conceptIds": [
                "pressure-to-scroll-mapping",
                "scrolling-amount",
                "pressure-value"
            ...
            {
              "id": "i1-communicate",
              "text": "cause the interface to communicate the scrolling commands specifying the respective scrolling amounts",
              "conceptIds": [
                "interface",
                "scrolling-command",
                "scrolling-amount"
        ...
        },
        {
          ...
          "limitations": [
            ...
            },
            {
              ...
              "text": "determine respective correction measures for the pressure intervals from the respective correction labels",
              "conceptIds": [
                "correction-measure",
                "pressure-interval",
                "correction-label"
            ...
            },
            {
              ...
              "text": "update a mapping value for a first pressure interval based on the correction measure for the first pressure interval",
              "conceptIds": [
                "mapping-value",
                "pressure-interval",
                "correction-measure"
        ...
        },
        {
          ...
          "kind": "dependent",
          "dependsOn": 3,
          "text": "4. The computer input system of claim 3, wherein the one or more processors are configured to update the mapping value for the first pressure interval while retaining a mapping value for a second pressure interval.",
          "limitations": [
            {
              "id": "i4-selective-update",
              "text": "update the first interval's mapping value while retaining a mapping value for a second pressure interval",
              "conceptIds": [
                "selective-interval-update",
                "mapping-value",
                "pressure-interval"
        ...
        },
        {
          ...
          "kind": "dependent",
          "dependsOn": 1,
          "text": "5. The computer input system of claim 1, wherein the one or more processors maintain different pressure-to-scroll mappings for different applications executing on the host device.",
          "limitations": [
            {
        ...
        },
        {
          ...
          "kind": "dependent",
          "dependsOn": 1,
          "text": "6. The computer input system of claim 1, wherein the pressure-responsive scrolling element comprises a force-sensing resistor.",
          "limitations": [
            {
              "id": "i6-fsr",
      ...
      "amendedClaims": [
        {
          ...
          "limitations": [
            ...
            },
            {
              ...
              "text": "maintain a pressure-to-scroll mapping comprising mapping values associated with respective pressure intervals",
              "conceptIds": [
                "pressure-to-scroll-mapping",
                "mapping-value",
                "pressure-interval"
            ...
            },
            {
              ...
              "text": "store records associating a pressure value used for a first scrolling command with a correction label indicating whether an opposite-direction command occurred within a correction interval afterward",
              "conceptIds": [
                "interaction-record",
                "pressure-value",
                "correction-label",
            ...
            },
            {
              ...
              "text": "determine respective correction measures for the pressure intervals from the correction labels",
              "conceptIds": [
                "correction-measure",
                "pressure-interval",
                "correction-label"
            ...
            },
            {
              ...
              "text": "update a first interval's mapping value from its correction measure while retaining a second interval's mapping value",
              "conceptIds": [
                "selective-interval-update",
                "mapping-value",
                "correction-measure",
        ...
        },
        {
          ...
          "kind": "dependent",
          "dependsOn": 1,
          "text": "2. The computer input system of claim 1, wherein the one or more processors are configured to reduce the first mapping value when the correction measure determined for the first pressure interval exceeds a correction threshold.",
          "limitations": [
            {
              "id": "a2-threshold-reduction",
              "text": "reduce the first mapping value when the first interval's correction measure exceeds a correction threshold",
              "conceptIds": [
                "mapping-value",
                "correction-measure",
                "update-threshold"
        ...
        },
        {
          ...
          "kind": "dependent",
          "dependsOn": 2,
          "text": "3. The computer input system of claim 2, wherein the one or more processors are configured to refrain from reducing the first mapping value until at least a minimum number of the records have been assigned to the first pressure interval.",
          "limitations": [
            {
              "id": "a3-minimum-records",
              "text": "refrain from reducing the first mapping value until a minimum number of records are assigned to the first pressure interval",
              "conceptIds": [
                "minimum-record-count",
                "interaction-record",
                "pressure-interval"
        ...
        },
        {
          ...
          "kind": "dependent",
          "dependsOn": 1,
          "text": "4. The computer input system of claim 1, wherein the pressure-to-scroll mapping comprises a monotonic piecewise-linear transfer function.",
          "limitations": [
            {
          ...
          "introducedTerms": [
            "monotonic piecewise-linear transfer function"
          ]
        },
        {
          "id": "amended-claim-5",
          ...
          "kind": "dependent",
          "dependsOn": 1,
          "text": "5. The computer input system of claim 1, wherein the records comprise a rolling window of records, and wherein the one or more processors are configured to exclude an outlier record from the rolling window based on at least one of pressure, timing, or scrolling amount.",
          "limitations": [
            {
              "id": "a5-window-outlier",
              "text": "use a rolling record window and exclude an outlier based on pressure, timing, or scrolling amount",
              "conceptIds": [
                "rolling-window",
                "outlier-record",
                "interaction-record"
        ...
        },
        {
          ...
          "kind": "dependent",
          "dependsOn": 1,
          "text": "6. The computer input system of claim 1, wherein the one or more processors are configured to maintain different pressure-to-scroll mappings for different applications executing on the host device.",
          "limitations": [
            {
      ...
      "revealPolicy": "Model claims are evaluator fixtures. A player view may reveal them only after the attempt is complete and the debrief has begun."
    },
    "hiddenTargetEmbodiments": [
      {
        ...
        "forbiddenNeedlessLimitations": [
          "force-sensing resistor",
          "host-only processing"
        ]
      },
      {
      ...
      },
      {
        ...
        "description": "A mouse with a pressure-sensitive scroll button and a controller divided between mouse firmware and a host driver.",
        "requiredConceptIds": [
          "pressure-responsive-element",
          "distributed-controller",
          "pressure-to-scroll-mapping"
    ...
    "expertReference": {
      ...
      "title": "System and method for implementing a control function via a sensor having a touch sensitive control input surface",
      ...
      "summary": "The cited portions discuss direction changes, discrete pressure ranges mapped to scrolling speeds, and modification of a pressure-to-output relationship in response to a stimulus.",
      "strengths": [
      ...
      "pinpoints": [
        ...
        },
        {
          ...
          "excerptType": "ScopeCraft paraphrase",
          "excerpt": "Discrete pressure ranges map to scrolling speeds, and a stimulus may modify the pressure-to-output relationship.",
          "conceptIds": [
            "pressure-interval",
            "scrolling-amount",
            "mapping-value",
      ...
      "frozenEvidenceManifest": {
        "snapshotId": "ref-e-curated-evidence-v1",
        "retrievalDate": "2026-08-24",
        "snapshotScope": "ScopeCraft-curated pinpoint manifest and paraphrased teaching summaries; no full patent text or PDF is embedded.",
        "hashAlgorithm": "SHA-256",
    ...
    "evidenceFacts": [
      {
        ...
        "proposition": "Reference A supplies a pressure-responsive mouse scrolling element and pressure-dependent scrolling output.",
        "conceptIds": [
          "pressure-responsive-element",
          "pressure-value",
          "scrolling-command",
      ...
      },
      {
        ...
        "proposition": "Reference B supplies learning-based selection or tuning of scroll speed or sensitivity from scrolling behavior.",
        "conceptIds": [
          "historical-adaptation",
          "scrolling-amount"
        ],
      ...
      },
      {
        ...
        "proposition": "Reference B supplies use of a rapid scroll followed by a short opposite-direction correction as feedback.",
        "conceptIds": [
          "correction-sequence",
          "correction-interval"
        ],
      ...
      },
      {
        ...
        "proposition": "Reference C supplies stored compensation parameters associated with a user or application.",
        "conceptIds": [
          "profile-specific-mapping",
          "historical-adaptation"
        ],
      ...
      },
      {
        ...
        "proposition": "Reference D supplies pressure ranges associated with mouse sensitivity states and calibration using measured pressure samples.",
        "conceptIds": [
          "pressure-value",
          "pressure-interval",
          "mapping-value"
      ...
      },
      {
        ...
        "proposition": "Reference D supplies state criteria associated with applications, user settings, or usage habits.",
        "conceptIds": [
          "profile-specific-mapping",
          "historical-adaptation"
        ],
      ...
      },
      {
        ...
        "proposition": "Reference D permits modification of selected response-curve points or individual parameters.",
        "conceptIds": [
          "mapping-value",
          "selective-interval-update"
        ],
        "mappingStrength": "partial",
        "qualification": "The cited disclosure is not tied to correction labels or per-pressure-interval correction statistics."
      },
      {
        ...
        "mappingStrength": "partial",
        "qualification": "The fixed pinpoint does not establish the entire claimed pressure-associated correction record."
      },
      {
        "id": "fact-e-range-response-update",
        "referenceId": "ref-e",
        "pinpointIds": [
          "ref-e-paragraphs-74-77"
        ],
        "proposition": "Reference E supplies discrete pressure ranges mapped to scrolling speeds and modification of the pressure-to-output relationship in response to a stimulus.",
        "conceptIds": [
          "pressure-interval",
          "scrolling-amount",
          "mapping-value",
    ...
    "rejectionRecipes": [
      {
        ...
        "rationale": "Within the exercise, Reference A's pressure-dependent scrolling relationship and Reference B's learned adjustment are combined as a predictable way to personalize scrolling response.",
        "whyNotAnticipation": "No single reference in the fixed evidence key maps every limitation of initial claim 1.",
        "confidence": "medium"
      },
      {
        ...
        "rationale": "References A and B supply the inherited limitations, and Reference B additionally uses a short opposite-direction correction to reduce later speed or acceleration.",
      ...
      },
      {
        ...
        "rationale": "The core record does not expressly map a stored pressure-and-correction label, a correction measure calculated for each pressure interval, and selective change of the implicated interval while retaining another interval. The fixed examiner supplies no complete articulated rationale for that combined architecture.",
        "caution": "The absence of an express teaching does not itself defeat obviousness. Claims 3 and 4 depend from rejected claims and are identified only as amendment targets.",
        "confidence": "medium"
      },
      {
        ...
        "rationale": "References A and B supply the inherited limitations, while Reference C supplies parameters stored by application. Reference D corroborates application-sensitive configuration.",
        "confidence": "high-within-key"
      },
      {
        ...
        "rationale": "References A and B supply the inherited limitations, and Reference A supplies the force-sensitive-resistor refinement.",
        "confidence": "high-within-key"
      },
      {
        ...
        "rationale": "The fixed core examiner does not locate a complete mapping or articulate why the cited teachings would produce the claimed pressure-labeled records, per-interval correction measures, and localized update that retains another interval value.",
        "resultCopy": "The rejection is withdrawn within this frozen challenge record. Amended claim 1 survives the supplied core references for this exercise.",
        "caution": "This is one plausible answer-key outcome, not a conclusion concerning actual patentability or an exhaustive obviousness analysis.",
        "confidence": "medium"
      },
      {
      ...
      },
      {
        ...
        "rationale": "The expert record adds range-specific scroll speeds and stimulus-responsive pressure-to-output modification, materially strengthening the rationale for applying correction feedback to separate pressure ranges. The answer key therefore requires an additional supported distinction, comparative evidence, or a stronger reasoned response.",
        "caution": "The expert outcome is still a bounded simulation and is not a patentability conclusion.",
        "confidence": "medium"
      }
    ],
    "mappingChallengeRulings": [
      {
        ...
        "explanation": "The fixed evidence for Reference A does not map updating the pressure-to-scroll mapping from a history. The key uses A with B under Section 103 rather than A alone under Section 102.",
        "evidenceFactIds": [
          "fact-a-pressure-mouse",
          "fact-b-learned-scroll"
        ]
      },
      {
        ...
        "prompt": "Reference B's reverse-scroll learning necessarily supplies pressure-associated correction statistics.",
        "challengedFindingId": "no-complete-map-initial-claims-3-4",
        "ruling": "challenge-sustained",
        "explanation": "The fixed B pinpoints supply correction-based learning but do not supply a measured pressure value, pressure assignment, or correction measure calculated for a pressure interval.",
        "evidenceFactIds": [
          "fact-b-learned-scroll",
          "fact-b-reverse-correction"
        ]
      },
      {
        ...
        "explanation": "The fixed D card permits selected curve points or parameters to be modified. The narrower distinction is that the cited modification is not driven by the claimed pressure-associated correction labels and per-interval statistics.",
        "evidenceFactIds": [
          "fact-d-editable-curve"
        ]
      },
      {
        ...
        "challengedFindingId": "withdraw-amended-claim-1-core",
        "ruling": "challenge-denied",
        "explanation": "The core result is only a medium-confidence simulated withdrawal. The alternate A+B+D ruling remains plausible, and undisclosed references or rationales may exist.",
        "evidenceFactIds": [
          "fact-a-pressure-mouse",
          "fact-b-reverse-correction",
          "fact-d-pressure-ranges",
      ...
      },
      {
        ...
        "prompt": "The competitor's global gain necessarily maps updating one pressure interval while retaining another interval value.",
        "challengedFindingId": "competitor-amended-claim-1-map",
        "ruling": "challenge-sustained",
        "explanation": "In the stipulated competitor model, one multiplier changes the whole curve. The model does not calculate per-interval measures or retain another interval's mapping value during a localized update.",
        "evidenceFactIds": []
      }
    ],
    "competitor": {
      ...
      "limitationMappings": [
        ...
        },
        {
          ...
          "status": "disputed",
          "explanation": "The curve may be described over pressure regions, but the stipulated model maintains one global gain rather than distinct learned values associated with respective intervals."
        },
        {
          "limitationId": "a1-labeled-records",
          "status": "partial",
          "explanation": "The product detects correction sequences, but the model does not stipulate records pairing each earlier pressure value with a correction label."
        },
        {
        ...
        },
        {
          ...
          "status": "not-mapped",
          "explanation": "The global multiplier changes the whole curve and does not update one interval while retaining another interval's value."
        },
        {
        ...
        },
        {
          ...
          "status": "disputed",
          "explanation": "A runtime curve lookup can use the current pressure, but the model does not stipulate selection from separately learned pressure intervals."
        },
        {
      ...
      "result": {
        ...
        "explanation": "The stipulated global-gain product appears to omit assigning pressure-associated records to pressure intervals, calculating a correction measure for each interval, and selectively updating one interval while retaining another interval's value.",
        "teachingPoint": "The amendment uses a technically meaningful relationship rather than incidental hardware, but global calibration may retain commercial value while avoiding the localized-update relationship in the fictional model.",
        "boundary": "A missing literal mapping in this fictional product model is not a noninfringement opinion. Real analysis requires claim construction, current legal status, prosecution history, related rights, jurisdiction, and facts concerning the actual product."
      }
    },
    "scoring": {
      "gates": [
        {
          ...
          "passRequirement": "The claim is complete, reasonably clear, and supported by the supplied fictional disclosure."
        },
        {
          "id": "coverage-gate",
          "label": "Coverage gate",
        ...
        },
        {
          ...
          "passRequirement": "At least one commercially useful claim survives the applicable frozen challenge record."
        }
      ],
      "weights": [
        {
          "id": "scope",
          "label": "Scope and hidden-variant coverage",
          "weight": 25
        },
        {
          "id": "support",
          "label": "Support and clarity",
          "weight": 20
        },
        {
          "id": "prior-art",
          "label": "Prior-art resilience",
          "weight": 20
        },
        {
          "id": "fallbacks",
          "label": "Dependent-claim ladder",
          "weight": 15
        },
        {
          "id": "design-around",
          "label": "Design-around resistance",
          "weight": 15
        },
        {
          "id": "efficiency",
          "label": "Claim and prosecution efficiency",
          "weight": 5
        }
      ],
      "portfolioCosts": [
      ...
      "benchmarks": [
        {
          ...
          "note": "This benchmark calibrates the model amendment within the core frozen record. A substantively different claim set must be rescored rather than receiving the fixture total by string similarity."
        }
      ],
      "workedResult": {
        "recordId": "core-record",
        ...
        "total": 76,
        "debrief": "The amended portfolio is supported and covers the required hardware and processing variants, but it is vulnerable to an alternate obviousness rationale and a global-gain design-around."
      }
    },
    "answerKey": {
      "coreRecord": {
      ...
      "expertRecord": {
        ...
        "controllingRecipeIds": [
          "maintain-amended-claim-1-expert"
        ]
      },
      "modelArgumentPoints": [
